    ...
    "topics": [
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "DESC",
            "data": "###  Slicing: \n\n String slicing is a feature that allows you to extract a portion of a string and create a new string out of it. The slice of a string is specified by two indices: the starting  index and the ending index. The slicing syntax is as follows:\n\n```python\nstring_name[start:end]\n\n```\n \n where **start **is the **starting index \\(inclusive\\)** and **end** is the **ending index \\(exclusive\\)**.\n\n **Examples:**\n```python\n# Example 1\nword = \"Hello World\"\nprint(word[0:5]) # Output: Hello\n\n# Example 2\nsentence = \"The quick brown fox jumps over the lazy dog.\"\nprint(sentence[4:9]) # Output: quick\n\n# Example 3\nstring = \"abcdef\"\nprint(string[1:4]) # Output: bcd\n\n# Example 4\ntext = \"Python is fun\"\nprint(text[7:]) # Output: 'is fun'\n\n# Example 5\nstring = \"abcdef\"\nprint(string[:3]) # Output: abc\n\n```\n \n In the above examples, you can see how the start and end indices define the portion of the string to be extracted. If the start index is omitted, \n it is assumed to be the beginning of the string. Similarly, if the end index is omitted, it is assumed to be the end of the string."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "type": "CONTENT",
            "data": "capitalize & title"
          },
          {
            "type": "DESC",
            "data": "**capitalize\\(\\)** and **title\\(\\)** are both string methods which are used the convert the first character of the \n word in the string to uppercase.\n\n###  Difference between capitalize\\(\\) and title\\(\\): \n\n The difference between **capitalize\\(\\) and title\\(\\)** is that, capitalize\\(\\) will only convert the first character of the \n sentence to uppercase, whereas the title\\(\\) will convert the first character of every word in the string  to upper case.\n \n Also in title\\(\\) if the first character of the word is a number or symbol, the first character after that will be converted\n to uppercase.\n\n###  Syntax:\n\n```python\n# Syntax for capitalize\nmain_string.capitalize()\n\n# Syntax for title\nmain_string.title()\n\n```\n\n###  Example for capitalize:\n\n```python\nmain_string = 'hello, I am varun'\nprint(main_string.capitalize())\n\n# Output\nHello, I am varun\n\n```\n\n### Example for title:\n\n```python\nmain_string = 'Hello, i am varun'\nprint(main_string.title());\n\n# Output\nHello, I Am Varun\n\nmain_string = 'hello, i am 2nd in my class'\nprint(main_string.title())\n\n# Output\nHello, I Am 2Nd In My Class\n\n```\n\n Note \\- the capitalize\\(\\) and title\\(\\) will always return the modified string and will not alter the original string."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "DESC",
            "data": "### List Append:\n\n  The append method in Python is used to add an element to the end of a list. It takes one argument, \n  the item you want to append to the list.\n\n```python\nlist_object_name.append(object)\n\n```\n where the object can be a string, number or another object.\n\n### Examples:\n\n```python\n#Example 1\nfruits = [\"apple\", \"banana\", \"cherry\"]\nfruits.append(\"orange\")\nprint(fruits) # Output - [\"apple\", \"banana\", \"cherry\", \"orange\"]\n\n#Example 2\nnumbers = [1, 2, 3, 4]\nnumbers.append(5)\nprint(numbers) # Output - [1, 2, 3, 4, 5]\n\n#Example 3\nfirst_list = [1, 2, 3, 4]\nfirst_list.append([3, 5, 6])\nprint(first_list) # Output - [1, 2, 3, 4, [3, 5, 6]]\n\n```\n\n Whatever is the argument that is passed to the append method will be added to the end of the list as it is."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "DESC",
            "data": "### List Pop:\n\n The **list\\.pop\\(index\\)** method in Python is used to remove an element from a list and return its value.\n The optional argument, index, specifies the position of the element to be removed, and if it is not provided,\n the method removes and returns the last element in the list by default.\n\n\n### Example\n\n```python\nmy_list = [1, 2, 3, 4, 5]\n\npopped_element = my_list.pop(2)\n\nprint(popped_element) # Output - 3\n\nprint(my_list) # Output - [1, 2, 4, 5]\n\n```\n\n In above example, the **list\\.pop** method is used to **remove the element at index 2** in the list my\\_list. The removed element is assigned to the \n variable  popped\\_element and its value is 3. After the removal, the list my\\_list becomes \\[1, 2, 4, 5\\].\n\n You can also use the **list\\.pop** method without any argument to remove and return the last element in the list:\n```python\nmy_list = [1, 2, 3, 4, 5]\n\npopped_element = my_list.pop()\n\nprint(popped_element) # Output - 5\n\nprint(my_list) # Output - [1, 2, 3, 4]\n\n```\n"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "DESC",
            "data": "**replace\\(\\)** as the name suggest is used to change/replace a particular string with another value. \n We can either replace all the occurrences or only certain count of occurances.\n\n### Syntax:\n\n```python\nstring.replace(stringToReplace, replaceString, count)\n\n# stringToReplace - Required. The string that needs to be replaced in the bigger string\n# replaceString - Required. The string used to replace the original string with\n# count - Optional. Number of occurrences to replace. Default value is -1 which \n#         replaces all the occurrences\n\n```\n\n### Examples:\n\n```python\ntext = 'Pandas are beautiful'\nreplaceText = text.replace('Pandas','Elephant')\nprint(replaceText)\n\n# Output\n# Elephant are beautiful \n\n```\n\n```python\n# replace() with the count param\ntext = \"I love appple.I love banana.I love orange\"\nreplaceText = text.replace('I', 'We', 2)\nprint(replaceText)\n\n# Output\n# We like apple.We like banana.I love orange\n\n```\n\n The **replace\\(\\)** will not alter the original string, rather return the replaced string. So until we **reassign it to a new variable**\n** or print it, we will not be able to see the replaced value**."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "DESC",
            "data": "The string **Join** method is used to join the values from an iterable object using the specified separator character or string.\n\n###  Syntax:\n\n```python\nseparatorString.join(iterableObject)\n\n```\n\n###  Example \\- Join using tuple as iterable object\n\n```python\ntupleObj = ('apple', 'mango', 'orange')\nseparator = '_'\nprint(separator.join(tupleObj)\n\n# Output\n# apple_mango_orange\n\n```\n\n###  Example \\- Join using dict as iterable object\n\n```python\ndictObj = {'name': 'ram', 'age': 23}\nseparator = '_'\nprint(separator.join(dictObj))\n\n# Output\n# name_age\n\n```\n\n**Note :\\-** When we use a dict as an iterable object to the join method, the dict keys are joined and not the values.\n\n### Example \\- Join using list as iterable object\n\n```python\nlistObj = ['apple', 'mango', 'orange']\nseparator = '_'\nprint(separator.join(listObj))\n\n# Output\n# apple_mango_orange\n\n```\n"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "DESC",
            "data": "###  List Insert:\n\n The _**list\\.insert\\(index, element\\)**_ method in Python is used to insert an element at a specific position in a list. \n The first argument, _**index**_, specifies the position in the list where the element should be inserted, and the second argument, \n _**element**_, is the value to be inserted.\n\n```python\n#Syntax\nlist.insert(index, element)\n\n# index - the position where the element to be inserted\n# element - the actual object to the inserted into the list\n\n```\n \n The element to be inserted into a list need not be a single number or a word. It can be other data types as well like a dictionary, set or a tuple.\n\n###  Examples:\n\n```python\nmy_list = [1, 2, 4, 5]\nmy_list.insert(2, 3)\nprint(my_list) # Output - [1, 2, 3, 4, 5]\n\nmy_list = [1, 2, 4, 5]\nmy_list.insert(2, [12, 34, 'Alice'])\nprint(my_list) # Output - [1, 2, [12, 34, 'Alice'], 4, 5]\n\n```\n"
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "type": "DESC",
            "data": "###  List Extend\n\n The **list\\.extend\\(iterable\\)** method in Python is used to add elements from an iterable \\(e.g., a list, a tuple, or a string\\) to the end of a list. \n The argument, **iterable**, can be any object that can be iterated upon, such as a list, a tuple, a string, etc. The elements of the iterable will be appended \n to the list one by one.\n\n###  Examples:\n\n```python\nmy_list = [1, 2, 4, 5]\nmy_list.extend([3, 6, 9])\nprint(my_list) # Output -  [1, 2, 4, 5, 3, 6, 9]\n\n```\n"
          }
        ]
      },
      {
